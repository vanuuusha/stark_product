NUM_THREADS = 3 # Сколько аккаунтов делать одновременно
MAX_FEE_FOR_TRANSACTION = 0.01 # Максимальная цена за транзакцию
RPC_URL = '' # получить RPC можно по ссылке https://app.infura.io/dashboard
...
okx_proxy = 'http://ps72077:Yn1dip2a6x@45.8.126.148:8000'
okx_apikey = ''
okx_secretkey = ''
okx_passphrase = ''
...
# TODO dmail
dmail = False # делаем dmail?
dmail_count_tx = [1, 2] # Количество транзакций в дмайл (от и до)

#TODO stark_id
stark_id = False # делаем starknet_id?
stark_id_count_mints = [1, 1] # Количество транзакций в старкнет ид (от и до)
...
myswap_add_liq = True # делаем myswap ликвидность (добавление)
